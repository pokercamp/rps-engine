...
PLAYER_1_SERVER_MESSAGES_PATH = 'A.messages.server'
PLAYER_1_PLAYER_MESSAGES_PATH = 'A.messages.player'
# NO TRAILING SLASHES ARE ALLOWED IN PATHS
PLAYER_2_NAME = 'B'
PLAYER_2_PATH = './player'
PLAYER_2_SERVER_MESSAGES_PATH = 'B.messages.server'
PLAYER_2_PLAYER_MESSAGES_PATH = 'B.messages.player'
